...
run node "$ROOT_DIR/dist/cli.js" ai test
...
run node "$ROOT_DIR/dist/cli.js" prompt TASK-001 --sanitize-preview --save
...
run node "$ROOT_DIR/dist/cli.js" relay-check TASK-002 --strict
